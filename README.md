...
The goal of this repository is to demonstrate my  skills of usage  Git, Angularjs, Typescript, Routing, Webpack, Ag-grid, Bootstrap for employers
As a base of the project I used https://github.com/frederikprijck/angularjs-webpack-starter
For my goal I have added ag-grid lib, edited webpack, tests and bootstraping
...
```
 git clone https://github.com/galina132/angularjs-webpack-typescript-router-ad-grid.git <directory_name> --depth=1
 cd <directory_name>
```
